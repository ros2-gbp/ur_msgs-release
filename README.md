...
## ur_msgs (kilted) - 2.6.0-1

The packages in the `ur_msgs` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro kilted` on `Thu, 02 Jul 2026 11:37:43 -0000`
...
## ur_msgs (jazzy) - 2.6.0-1

The packages in the `ur_msgs` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro jazzy` on `Thu, 02 Jul 2026 11:34:27 -0000`
...
## ur_msgs (humble) - 2.6.0-1

The packages in the `ur_msgs` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro humble` on `Thu, 02 Jul 2026 11:30:58 -0000`
...
## ur_msgs (humble) - 2.5.0-1

The packages in the `ur_msgs` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro humble` on `Thu, 26 Mar 2026 07:24:47 -0000`
...
## ur_msgs (jazzy) - 2.5.0-1

The packages in the `ur_msgs` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro jazzy` on `Thu, 26 Mar 2026 07:19:21 -0000`
...
## ur_msgs (kilted) - 2.5.0-1

The packages in the `ur_msgs` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro kilted` on `Thu, 26 Mar 2026 07:14:04 -0000`
...
## ur_msgs (rolling) - 2.5.0-1

The packages in the `ur_msgs` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro rolling` on `Thu, 26 Mar 2026 07:08:48 -0000`
...
## ur_msgs (rolling) - 2.4.0-1

The packages in the `ur_msgs` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro rolling` on `Fri, 20 Mar 2026 10:01:30 -0000`
...
## ur_msgs (kilted) - 2.4.0-1

The packages in the `ur_msgs` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro kilted` on `Fri, 20 Mar 2026 09:57:48 -0000`
...
## ur_msgs (jazzy) - 2.4.0-1

The packages in the `ur_msgs` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro jazzy` on `Fri, 20 Mar 2026 09:53:58 -0000`
...
## ur_msgs (humble) - 2.4.0-1

The packages in the `ur_msgs` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_msgs --rosdistro humble` on `Fri, 20 Mar 2026 09:27:51 -0000`
...
## ur_msgs (humble) - 2.2.0-1

The packages in the `ur_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble ur_msgs` on `Mon, 17 Mar 2025 09:44:50 -0000`
...
The packages in the `ur_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy ur_msgs` on `Mon, 17 Mar 2025 09:42:47 -0000`
